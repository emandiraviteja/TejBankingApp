...
import com.raviteja.tejbankingapp.databinding.ItemTransactionBinding

class TransactionsAdapter: ListAdapter<Transaction, TransactionsAdapter.CategoryViewHolder>(
    NoteDiffUtil()
) {
